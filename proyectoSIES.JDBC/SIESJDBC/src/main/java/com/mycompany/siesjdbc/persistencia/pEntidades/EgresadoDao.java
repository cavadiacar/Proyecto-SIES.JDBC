...
import com.mycompany.siesdjdbc.persistencia.Dao;
...
public class EgresadoDao extends Dao {
    ...
    public void guardarEstudiante(Egresado estudiante) throws Exception {
        try {
            if (estudiante == null) {
    ...
    public void modificarEstudiante(Egresado estudiante) throws Exception {
        try {
            if (estudiante == null) {
    ...
    public Collection<Egresado> listarEstsudiantes() throws Exception {
        try {
