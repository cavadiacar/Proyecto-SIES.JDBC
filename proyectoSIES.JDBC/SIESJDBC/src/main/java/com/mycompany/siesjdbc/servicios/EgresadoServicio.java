...
import com.mycompany.siesjdbc.enums.Cursos;
...
public class EgresadoServicio {
    ...
    public void crearEgresado() {
        System.out.println("Bienvenido a la creación de estudiantes");
        try {
    ...
    public void modificarEstudiante() {
        ...
        try {
            ...
            if (ed.buscarEstudiantePorId(estudiante.getId()) == null) {
                ...
                estudiante.setApellido(sc.next());
                estudiante.setEstadoCivil(estadoCivil());
                ed.modificarEstudiante(estudiante);
                System.out.println("¿Desea matricular al estudiante en algún curso? S/N");
                String opcion = sc.next();
                validarSN(opcion);
                if (opcion.equalsIgnoreCase("s")) {
    ...
    public void listarEgresados() {
        ...
        try {
            ArrayList<Egresado> estudiantes = (ArrayList<Egresado>) ed.listarEstsudiantes();
