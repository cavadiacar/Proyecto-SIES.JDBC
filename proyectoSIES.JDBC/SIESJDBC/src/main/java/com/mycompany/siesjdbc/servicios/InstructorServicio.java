...
import com.mycompany.siesjdbc.enums.Carreras;
import com.mycompany.siesjdbc.enums.EstadoCivil;
...
public class InstructorServicio {
    ...
    public String departamento() {
        ...
        int cont = 1;
        for (Carreras aux : Carreras.values()) {
        ...
        switch (opcion) {
            case 1:
                return Carreras.values()[0].departamento;
            case 2:
                return Carreras.values()[1].departamento;
            case 3:
                return Carreras.values()[2].departamento;
            case 4:
                return Carreras.values()[3].departamento;
            case 5:
                return Carreras.values()[4].departamento;
            case 6:
                return Carreras.values()[5].departamento;
